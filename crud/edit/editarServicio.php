      ...
      <div class="main-skills">
        <form action="updateServicio.php" method="POST">
          ...
          try {
            ...
            $bpais = $conexion->query("select id_servicio, descripcion from servicio where id_servicio='" . $vcodigo . "'");
            $bpais->setFetchMode(PDO::FETCH_ASSOC);
            $row = $bpais->fetch();

            $vservicio = $row['id_servicio'];
          ...
          <table style="text-align: left">
            ...
            <tr>
              ...
              <td>
                <?php echo "<input type='text' id='descripcion' name='descripcion' value='" . htmlspecialchars($vdescripcion, ENT_QUOTES) . "'>"; ?>
              </td>
            </tr>
            <tr>
              <th></th>
            ...
            <tr>
              <td style="padding-top: 5%;border:0px;">
                <input class="testbutton" type="submit" value="Actualizar Servicio">
              </td>
            </tr>
          </table>
        </form>
