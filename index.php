    ...
    <section class="gato-perro-hamster_container">
        <div style="width: 100%" class="row">
            <article class="icon-text col-lg-4 col-xl-4 col-sm-12">
                <h3>GATOS</h3>
                <p>El gato doméstico​​, llamado más comúnmente gato, y de forma coloquial minino, ​ michino, ​ michi, ​
                    micho, ​ mizo, ​ miz, ​ morroño​ o morrongo, ​ y algunos nombres más, es un mamífero carnívoro de la
                    familia Felidae. Es una subespecie domesticada por la convivencia con el ser humano.</p>
            </article>

            <article class="icon-text col-lg-4 col-xl-4 col-sm-12">
                <h3>PERROS</h3>
                <p>El perro, ​​​ llamado perro doméstico o can, ​ y en algunos lugares coloquialmente llamado chucho, ​
                    tuso, ​ choco, ​ entre otros; es un mamífero carnívoro de la familia de los cánidos, que constituye
                    una especie del género Canis.</p>
            </article>

            <article class="icon-text col-lg-4 col-xl-4 col-sm-12">
                <h3>HÁMSTERES</h3>
                <p>Los cricetinos son una subfamilia de roedores, conocidos comúnmente como hámsteres.​​ Se han
                    identificado diecinueve especies actuales, agrupadas en siete géneros. La mayoría son originarias de
                    Oriente Medio y del sureste de los Estados Unidos.</p>
            </article>
        </div>
    </section>
