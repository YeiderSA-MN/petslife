...
<div class="container" style="width:600px;">
  <table class="table table-striped">
    ...
    <tr>
      ...
      <td style="text-align:center;  font-weight: bold; color:green; font-size: 18px"><?php print $product['cantidad']?></td>
      <?php $subtotal = $subtotal+$product['price']*$product['cantidad'];?>
      <td style="text-align:center;  font-weight: bold; font-size: 16px">$<?php print number_format($subtotal,0,',','.')?></td>
      <?php $subtotal=0;?>
    </tr>
    <?php $total = $total+$product['price']*$product['cantidad'];?>
    <?php endforeach;?>
    <tr><td colspan="5" align="right">    <h4 style="text-align:right;color:green;font-size:22px">Total a Pagar: $ <?php print number_format($total,0,',','.')?></h4></td></tr>
  </table>
