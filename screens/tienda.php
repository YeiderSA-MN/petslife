...
<body>
    ...
    <?php include_once "../components/sidebarDashboard.php"; ?>
        ...
        <?php if(!empty($_SESSION['products'])):?>
            ...
            <div class="navbar-header"> <h3 class="navbar-brand" style="color:#000000;">Carrito de Compras</h3> </div>
            </div>
            <div class="pull-right" style="margin-top:7px;margin-right:7px;"><a href="tienda.php?action=emptyall" style="background-color: #FAD2AA;" class="btn btn-info">Vaciar carrito</a></div>
            <div class="pull-right" style="margin-top:7px;margin-right:7px;"><a href="carrito2_petslife.php" style="background-color: #DEFAAA;" class="btn btn-info">Ir a pagar</a></div>
            ...
            <tr>
                ...
                <td>
                    <form method="get" action="tienda.php">
                        ...
                        <input type="number" style="text-align:center;  font-weight: bold; color:red; font-size: 18px" name="cantidad" value="1" min="1" max="<?php echo $product['cantidad'] ?>">
            ...
            <tr>
                ...
                <br><br>
                    <h4 style="text-align:right;color:green;font-size:22px">
                        Total a pagar     :    $<?php print number_format($total,0,',','.')?>
                    </h4>
                </td>
            </tr>
        </table>
                            ...
                            <td>
                                <form method="post" action="tienda.php?action=addcart">
                                    <div class="input-group">
                                        <input type="number" style="text-align:center;  font-weight: bold; color:red; font-size: 18px" name="cantidad" class="form-control" value="1" min="1">
                                        <input type="hidden" name="codigo" value="<?php print $product['id_producto']?>">
